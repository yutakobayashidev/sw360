            ...
            <td colspan="3">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="creatorComment" rows="5"
                        placeholder="Enter creator comment"><sw360:out value="${spdxDocumentCreationInfo.creatorComment}"/></textarea>
                </div>
            </td>
        </tr>
        <tr class="spdx-full">
            <td colspan="3">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="documentComment" rows="5"
                        placeholder="Enter document comment"><sw360:out value="${spdxDocumentCreationInfo.documentComment}"/></textarea>
                </div>
            </td>
        </tr>
    </tbody>
