...
import org.eclipse.sw360.rest.resourceserver.core.serializer.JsonProjectDTORelationSerializer;
...
public class JacksonCustomizations {
	...
	static abstract class EmbeddedProjectMixin extends ProjectMixin {
        ...
        public static abstract class ProjectDTOMixin extends ProjectDTO {
            ...
            @Override
            @JsonSerialize(using = JsonProjectDTORelationSerializer.class)
            @JsonProperty("linkedProjects")
            abstract public Map<String, ProjectProjectRelationship> getLinkedProjects();
