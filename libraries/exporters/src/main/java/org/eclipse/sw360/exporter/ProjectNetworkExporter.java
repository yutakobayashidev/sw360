...
import org.eclipse.sw360.exporter.helper.ProjectNetworkHelper;
...
import static org.eclipse.sw360.datahandler.thrift.projects.Project._Fields.CLEARING_STATE;

public class ProjectNetworkExporter extends ExcelExporter<Project, ProjectNetworkHelper>{
    ...
    public ProjectNetworkExporter(ComponentService.Iface componentClient, ProjectService.Iface projectClient, User user, List<Project> projects, boolean extendedByReleases) throws SW360Exception {
        super(new ProjectNetworkHelper(projectClient, user, extendedByReleases, new ReleaseHelper(componentClient, user)));
        preloadRelatedDataFor(projects, extendedByReleases, user);
    }

    public ProjectNetworkExporter(ComponentService.Iface componentClient, ProjectService.Iface projectClient, User user,
