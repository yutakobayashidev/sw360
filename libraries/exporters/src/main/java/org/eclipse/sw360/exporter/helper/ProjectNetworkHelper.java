...
public class ProjectNetworkHelper implements ExporterHelper<Project> {
    ...
    public ProjectNetworkHelper(ProjectService.Iface projectClient, User user, boolean extendedByReleases, ReleaseHelper releaseHelper) {
